...
-- Insert a forum
INSERT INTO forums (id, name, dob, title, text, date, topic, user_id)
 VALUES (1000, 'Tamara', '1991-07-06', 'Verdriet',
        ...
        (1010, 'Moana', '1980-05-28', 'Waarom kan ik niet stoppen met TV kijken?',
         ...
         '2024-06-06', 'Overige', 'Moana'),
        (1011, 'Ariel', '1958-10-25', 'Dit is een test forum', 'banaan', '2024-06-06', 'Werk', 'Ariel');
...
INSERT INTO comments (id, forum_id, name, text, date, user_id)
 VALUES (2000, 1003, 'Moana',
         ...
         '2024-06-10', 'Moana'),
        (2001, 1003, 'Nala', 'Oef, kan je hulp inschakelen?', '2024-06-07', 'Nala'),
        (2002, 1003, 'Tamara',
         ...
         '2024-07-06', 'Tamara'),
        (2003, 1003, 'Sarabi', 'Ik heb huishoudelijke hulp ingeschakeld want het lukt mij ook echt niet.', '2024-07-06',
         'Sarabi'),
        (2004, 1005, 'Elsa',
        ...
        (2009, 1005, 'Ariel', 'In mijn omgeving krijg ik ook vaak terug "jaja iedereen heeft nu een rugzakje"...',
         '2024-09-01', 'Ariel'),
        (2010, 1006, 'Ariel', 'Dat lijkt mij ook echt een hel om te doen!', '2024-08-06', 'Ariel'),
        (2011, 1006, 'Tiana',
         ...
         '2024-08-06', 'Tiana'),
        (2012, 1006, 'Nala', 'Tja toch het eerlijke & moeilijke gesprek aangaan?', '2024-08-20', 'Nala'),
        (2013, 1007, 'Sarabi',
